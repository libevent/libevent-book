...
static void add_content_length(struct evhttp_request *req, unsigned len) {
  char buf[128];
...
static void path_join(char *destination, const char *path1, const char *path2) {
  if (path1 && *path1) {
...
static void send_file_to_user(struct evhttp_request *req, void *arg) {
